                ...
                <p>
                  {plan.title === "Standart"
                    ...
                    : plan.title === "Pro"
                      ...
                      : plan.title === "VIP"
                        ? "Формат с большим экраном 65 дюймов, MOZA R9 и шифтером Simagic для максимального погружения."
                        : "Полное погружение с обзором на 360°. VR можно добавить к любому симулятору: одновременно доступно до пяти комплектов для общего заезда с друзьями."}
                </p>
              </article>
            ))}
          </div>
