...
export const metadata: Metadata = {
  ...
  description:
    "Ответы на частые вопросы АвтоСим: игры, возраст, компания друзей, тренировка вождения, VR и бронирование.",
  alternates: {
    canonical: "/faq"
  }
};
    ...
    <main>
      ...
      <section className="page-hero">
        <div className="container page-hero__inner">
          ...
          <p>
            Собрали главное перед первым визитом: возраст, игры, компания,
          ...
          <div className="button-row">
            <LeadButton
              ...
              messagePlaceholder="Например: можно ли прийти с ребенком 12 лет и забронировать VR на час?"
            >
              Задать вопрос
            </LeadButton>
        ...
        <div className="container narrow">
          <div className="content-block">
            <p>
              ...
              автосимуляторов АвтоСим: как забронировать время, с какого
              возраста можно приходить, какие игры доступны, как проходит заезд
