    ...
    <main>
      ...
      <section className="page-hero">
        <div className="container page-hero__inner">
          ...
          <p>
            Собрали главное перед первым визитом: рост, игры, совместные
            VR-заезды, тренировка вождения и бронирование.
          </p>
        ...
        <div className="container narrow">
          <div className="content-block">
            <p>
              ...
              с друзьями, как устроен VR-формат и чем отличаются обычные сессии
              от мероприятий.
            </p>
          </div>
          <FaqList />
