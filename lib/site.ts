...
export const pricePlans: PricePlan[] = [
  ...
  {
    title: "VR-очки",
    subtitle: "Полное погружение и обзор на 360°. Добавляется к любому симулятору - одновременно до 5 участников в общем заезде",
    items: [
...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "Да. Компания до 7 человек едет в одной сетевой гонке, а одновременно подключить VR-очки можно к пяти местам. Доступен и смешанный формат: часть участников едет в VR, остальные - на мониторах, но старт и заезд у всех общие."
  },
  {
